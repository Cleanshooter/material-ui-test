  ...
  (0, _createClass3.default)(TableBody, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (this.props.setSelectedRows !== nextProps.setSelectedRows) {
        ...
        if (Array.isArray(nextProps.setSelectedRows)) {
          // Check if in bounds
          var inBounds = true;
          nextProps.setSelectedRows.forEach(function (index) {
            if (index > _this2.props.children.length) inBounds = false;
          });
          if (inBounds) {
            this.setState({
    ...
    value: function createRows() {
      ...
      return _react2.default.Children.map(this.props.children, function (child) {
        if (_react2.default.isValidElement(child)) {
          var props = {
            hoverable: _this3.props.showRowHover,
            selected: _this3.isRowSelected(rowNumber),
            striped: _this3.props.stripedRows && rowNumber % 2 === 0,
            rowNumber: rowNumber++
          };
          ...
          var children = [_this3.createRowCheckboxColumn(props)];
    ...
    value: function isRowSelected(rowNumber) {
      ...
      return this.state.selectedRows.some(function (row) {
        if ((typeof row === 'undefined' ? 'undefined' : (0, _typeof3.default)(row)) === 'object') {
          if (_this5.isValueInRange(rowNumber, row)) {
            return true;
          }
        } else {
          if (row === rowNumber) {
    ...
    value: function flattenRanges(selectedRows) {
      ...
      return selectedRows.reduce(function (rows, row) {
        if ((typeof row === 'undefined' ? 'undefined' : (0, _typeof3.default)(row)) === 'object') {
          var values = _this6.genRangeOfValues(row.end, row.start - row.end);
...
process.env.NODE_ENV !== "production" ? TableBody.propTypes = {
   ...
   * value is false.
   */
  setSelectedRows: _propTypes2.default.array,
  /**
